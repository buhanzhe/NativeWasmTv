...
public final class QuickJsInstrumentation extends Instrumentation {
    ...
    @Override public void onStart() {
        ...
        try {
            if (testKu9Sources) {
                results.putString("stream", Ku9SourceSmokeTest.run(getTargetContext()));
                finish(-1, results);
                return;
            }
